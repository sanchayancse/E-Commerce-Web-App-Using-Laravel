...
<body>
	...
	<script src="{{asset('backend/js/jquery.flot.resize.min.js')}}"></script>
		...
		<script src={{asset('https://cdnjs.cloudflare.com/ajax/libs/bootbox.js/5.4.0/bootbox.min.js')}} integrity="sha512-8vfyGnaOX2EeMypNMptU+MwwK206Jk1I/tMQV4NkhOz+W8glENoMhGyU6n/6VgQUhQcJH8NqQgHhMtZjJJBv3A==" crossorigin="anonymous"></script>
	<!-- end: JavaScript-->
